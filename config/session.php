...
return [
    ...
    | requests. By default, we will use the lightweight file session driver
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Setting this value to true will tie the cookie to the top-level site in
    | a given context. Partitioned cookies are accepted by the browser when
    | flagged "secure" and are used only in same-site contexts.
    |
    */
